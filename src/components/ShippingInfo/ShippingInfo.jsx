    ...
    return(
      <div>
        <form>
          ...
          <div> Date to be shipped: 
            <input type="text" placeholder="MM/DD/YY" onChange={(evt)=>{setDate(evt.target.value)}}/> 
          </div>

          <div> Carrier: 
            <input type="text" placeholder="Not Specified" onChange={(evt)=>{setCarrier(evt.target.value)}}/>
          </div>

          <div> Tracking Number: 
            <input type="text" onChange={(evt)=>{setTracking(evt.target.value)}}/>
          </div>

          <span> 
            <button onClick={handleBack}> Back to add sample </button>
